 ...
 */
public class Recruteur_AllOffresForm extends Form {

    public Recruteur_AllOffresForm(Resources res) {
        super("Offres", BoxLayout.y());

        // Create button group menu at the top
        ButtonGroup barGroup = new ButtonGroup();

        RadioButton liste = RadioButton.createToggle("Liste Offres", barGroup);
        ...
        liste.addActionListener((e) -> {
            ...
            Recruteur_AllOffresForm a = new Recruteur_AllOffresForm(res);
            a.show();
            refreshTheme();
            ipDlg.dispose();
        });
        ...
        ArrayList<Offre> offres = OffreService.getInstance().affichageOffreExceptUser(69);
